#!/bin/bash
# init.sh — Create a GCP project and link billing for Gemini Motion Lab
#
# Usage:
...
if [ "$PROJECT_ID_SET" = false ]; then
    ...
    CODELAB_PROJECT_PREFIX="gemini-motion-lab"
...
python3 "$SCRIPT_DIR/billing-enablement.py" || handle_error "The billing enablement script failed. See the output above for details."
